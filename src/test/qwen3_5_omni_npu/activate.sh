...
# copy xclbins
# cp /scratch/$USER/FastFlowLM/FLM_Xclbin/Qwen3_6/qwen3_6_moe_decoding/build/QWEN3_6_35B_A3B/xclbins/layer.xclbin ../../xclbins/Qwen3.6-35B-A3B-NPU2/
...
# cp /scratch/$USER/FastFlowLM/FLM_Xclbin/Qwen3_5/lm_head_npu_bin/build/QWEN3_5_2B/xclbins/lm_head.xclbin ../../xclbins/Qwen3.6-35B-A3B-NPU2/
